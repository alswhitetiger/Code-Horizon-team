    ...
    <div className="space-y-4">
      ...
      {report && (
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-6 space-y-4">
          ...
          <div>
            <h4 className="font-medium text-gray-700 dark:text-gray-300 mb-2">주요 현황</h4>
            <ul className="space-y-1">{(report.highlights || []).map((h, i) => (
          ...
          <div>
            <h4 className="font-medium text-gray-700 dark:text-gray-300 mb-2">우려 사항</h4>
            <ul className="space-y-1">{(report.concerns || []).map((c, i) => (
              <li key={i} className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <h4 className="font-medium text-gray-700 dark:text-gray-300 mb-2">권고 조치</h4>
            <ul className="space-y-1">{(report.recommendations || []).map((r, i) => (
              <li key={i} className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
